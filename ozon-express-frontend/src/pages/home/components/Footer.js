...
function Footer() {
    ...
    const Links = [
        ...
        { titre: "OZON Market", url: 'market', style: 'font-bold text-ozon-red' },
    ...
    return (
        <footer id='footer' className="bg-ozon-gray pt-10 py-5 rounded-t-3xl dark:bg-ozon-dark-gray">
            <div className="container flex flex-col justify-center mx-auto px-5 md:px-10 xl:px-20">
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3">
                    <div className="flex flex-col justify-start items-start mb-8 lg:mb-0">
                        ...
                        <div className="flex justify-between space-x-4 mt-6 lg:mt-8">
                            <a href="http://" target="_blank" className='text-lg xl:text-xl hover:text-ozon-red duration-300 dark:text-white dark:hover:text-ozon-red'>
                                <FaFacebook />
                            </a>
                            <a href="http://" target="_blank" className='text-lg xl:text-xl hover:text-ozon-red duration-300 dark:text-white dark:hover:text-ozon-red'>
                                <FaInstagram />
                    ...
                    <div className="md:grid lg:block grid-cols-2 mb-8 lg:mb-0">
                        ...
                        <div className="md:hidden lg:block mt-8">
                            ...
                            {/* Email */}
                            <form className='mt-5'>
                                <label className="flex justify-between w-full rounded-full border border-ozon-red ">
                                    <input type="email" className="text-ozon-red bg-transparent placeholder:text-ozon-red/60 text-xs sm:text-sm outline-none ml-3 xl:ml-5 mx-2 xl:mx-5" placeholder='exemple@gmail.com' />
                                    <button className='bg-ozon-red hover:bg-ozon-red-tone rounded-full text-xs sm:text-sm py-2.5 px-6 xl:px-10 my-1 mr-1 focus:ring-4 focus:outline-none focus:ring-ozon-red-tint'>
                                        <span className='font-semibold text-white'>S'abonner</span>
                                    </button>
                                </label>
                            </form>
                        </div>
                    ...
                    <div className="hidden md:block lg:hidden w-full">
                        ...
                        <form className='mt-5'>
                            <label className="flex justify-between w-full rounded-full border border-ozon-red">
                                <input type="email" className="text-ozon-red bg-transparent placeholder:text-ozon-red/60 text-xs sm:text-base outline-none ml-3 mx-1" placeholder='exemple@gmail.com' />
                                <button className='bg-ozon-red hover:bg-ozon-red-tone rounded-full text-xs sm:text-base py-2.5 px-6 my-1 mr-2 focus:ring-4 focus:outline-none focus:ring-ozon-red-tint'>
                                    <span className='font-semibold text-white'>S'abonner</span>
                                </button>
                            </label>
                        </form>
                ...
                <div className="mt-10">
                    <p className="text-xs md:text-sm text-center whitespace-nowrap dark:text-white">
                        © {year} OzonExpress. All rights reserved
                    </p>
                </div>
            </div>
        </footer>
