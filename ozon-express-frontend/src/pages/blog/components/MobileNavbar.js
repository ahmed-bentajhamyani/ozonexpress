            ...
            <div className='container mx-auto px-5 md:px-10 xl:px-20 py-3 flex flex-col justify-center items-center h-screen outline-none focus:outline-none'>
                ...
                <div className="flex justify-between items-center w-full select-none">
                    <div className="flex justify-between items-center">
                        ...
                        {/* Logo */}
                        <div onClick={() => goTo('/blogs')} className="cursor-pointer">
                ...
                <div className='flex flex-1 flex-col justify-between w-full mt-8'>
                    ...
                    {/*footer*/}
                    <button type='button' className='flex justify-center items-center font-medium text-lg w-full h-14 px-10 py-3 space-x-1 text-white bg-ozon-red hover:bg-ozon-red-tone cursor-pointer rounded-full whitespace-nowrap focus:ring-4 focus:outline-none focus:ring-ozon-red-tint'>
                        Se connecter
                    </button>
                </div>
            </div>
